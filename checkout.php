      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paypal">QR Code</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" value="Maharashtra" class="box" readonly>
         </div>
         <div class="inputBox">
            <span>Country :</span>
            <input type="text" name="country" value="India" class="box" readonly>
         </div>
